...
Location: `products/{name}/reviews/conflicts/YYYY-MM-DD-conflict-{type}.md`
    ...
    conflicts:
      - date: "YYYY-MM-DD"
        ...
        affected_docs:
          ...
          - "{prd.md}"
        status: "resolved"
        resolution_file: "products/{name}/reviews/conflicts/YYYY-MM-DD-conflict.md"
```
