...
**Save to**: `products/{product-name}/YYYY-MM-DD-project-brief.md`
...
- [ ] project-brief.md created at `products/{name}/YYYY-MM-DD-project-brief.md`
...
products:
  - name: {product-name}
    ...
    project_brief_file: "products/{name}/YYYY-MM-DD-project-brief.md"
```
