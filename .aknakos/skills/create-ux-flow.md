...
**Save to**: `products/{product-name}/YYYY-MM-DD-ux-flow.md`
...
- [ ] ux-flow.md created at `products/{name}/YYYY-MM-DD-ux-flow.md`
...
products:
  {product-name}:
    ...
    ux_flow_file: "products/{name}/YYYY-MM-DD-ux-flow.md"
```
...
- `products/{name}/tech-stack.md` - Frontend framework and capabilities
- `products/{name}/architecture.md` - Technical constraints and opportunities
- `products/{name}/project-brief.md` - User context and market research
