...
```
@products/{name}/reviews/{epic-name}/YYYY-MM-DD-test-review.md
@products/{name}/reviews/{epic-name}/YYYY-MM-DD-security-review.md
@products/{name}/reviews/{epic-name}/YYYY-MM-DD-architecture-review.md
@products/{name}/reviews/{epic-name}/YYYY-MM-DD-quality-review.md
@products/{name}/reviews/{epic-name}/YYYY-MM-DD-requirements-review.md
```

**Optional** (for context):
```
@products/{name}/epics/{epic-name}.md
