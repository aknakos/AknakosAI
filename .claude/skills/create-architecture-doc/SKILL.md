...
description: Create comprehensive architecture specification through BMAD Architect-style technical exploration. Use when: - **Optional**: For complex products (Complexity 4-9) OR novel architecture decisions
---
...
- [ ] architecture.md created at `.aknakos/products/{name}/YYYY-MM-DD-architecture.md`
- [ ] tech-stack.md created at `.aknakos/products/{name}/tech-stack.md`
...
- `.aknakos/products/{name}/project-brief.md` - Market/user context
