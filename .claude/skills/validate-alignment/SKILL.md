...
description: Proactive alignment validation ensuring Epics align with PRD, Architecture, and Mission. Use when: - **Required**: After Epic breakdown (Phase 3), before planning mode (Phase 4)
---
...
@.aknakos/products/{name}/epics/*.md (all Epic files)
```
...
`.aknakos/products/{name}/reviews/validation/YYYY-MM-DD-epic-validation.md`
...
products:
  - name: {product-name}
    ...
    validation_file: ".aknakos/products/{name}/reviews/validation/YYYY-MM-DD-epic-validation.md"
