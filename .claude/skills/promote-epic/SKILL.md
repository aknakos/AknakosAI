---
name: promote-epic
description: Move Epic through validation stages from backlog → drafted → ready for planning Use when: When ready to promote backlog item to active work, requires validation
---
