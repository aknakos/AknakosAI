---
name: create-mission
description: Create lightweight product mission and roadmap files through conversational discovery. Use when: - **Required**: At the start of every product (Phase 1a)
---
