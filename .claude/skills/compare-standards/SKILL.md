...
description: Show product-specific vs framework default standards differences and visualize inheritance hierarchy. Use when: - **After create-standards**: Review customizations made
---
