...
```
# Testing standards:
@.aknakos/products/{name}/standards/testing-standards.yaml  # Check first
...
**File**: `.aknakos/products/{product-name}/plans/{epic-name}/YYYY-MM-DD-plan.md`
...
`.aknakos/products/{product-name}/reviews/{epic-name}/YYYY-MM-DD-test-review.md`
